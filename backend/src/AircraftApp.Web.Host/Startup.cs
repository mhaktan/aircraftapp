...
namespace AircraftApp.Web.Host
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "AircraftApp API", Version = "v1" });
            ...
            return services.AddAbp<AircraftAppWebHostModule>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "AircraftApp API V1");
            });
