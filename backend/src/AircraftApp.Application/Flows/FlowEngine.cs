                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = Type.GetType("AircraftApp.Approvals.IApprovalAppService, AircraftApp.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in AircraftApp.Application assembly");
                            ...
                            var submitInputType = Type.GetType("AircraftApp.Approvals.Dto.SubmitApprovalInput, AircraftApp.Application")!;
