...
const extractToken = (data: Record<string, unknown>, path: string): string | undefined => {
  ...
  const fallbacks = ['data.token', 'data.accessToken', 'data.access_token', 'token', 'accessToken', 'access_token', 'result.token'];
...
const RESOURCE_CONFIG: Record<string, ResourceConfig> = {
  ...
  'MaintenanceType': { path: 'api/services/app/MaintenanceType', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'MaintenanceRequest': { path: 'api/services/app/MaintenanceRequest', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'MaintenanceLog': { path: 'api/services/app/MaintenanceLog', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'SparePart': { path: 'api/services/app/SparePart', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'MaintenancePartUsage': { path: 'api/services/app/MaintenancePartUsage', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
