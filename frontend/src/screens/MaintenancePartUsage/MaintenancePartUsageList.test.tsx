...
import { MaintenancePartUsageList } from './MaintenancePartUsageList';
...
describe('MaintenancePartUsageList', () => {
  it('should render without crashing', () => {
    const { container } = render(<MaintenancePartUsageList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<MaintenancePartUsageList />, { wrapper });
    expect(screen.getByText('MaintenancePartUsage')).toBeDefined();
  });

  it('should have create button', () => {
    render(<MaintenancePartUsageList />, { wrapper });
    expect(screen.getByText('+ Create MaintenancePartUsage')).toBeDefined();
  });
