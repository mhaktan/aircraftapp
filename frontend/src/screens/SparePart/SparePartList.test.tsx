...
describe('SparePartList', () => {
  it('should render without crashing', () => {
    const { container } = render(<SparePartList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<SparePartList />, { wrapper });
    expect(screen.getByText('SparePart')).toBeDefined();
  });

  it('should have create button', () => {
    render(<SparePartList />, { wrapper });
    expect(screen.getByText('+ Create SparePart')).toBeDefined();
  });
