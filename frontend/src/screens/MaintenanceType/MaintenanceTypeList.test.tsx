...
import { MaintenanceTypeList } from './MaintenanceTypeList';
...
describe('MaintenanceTypeList', () => {
  it('should render without crashing', () => {
    const { container } = render(<MaintenanceTypeList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<MaintenanceTypeList />, { wrapper });
    expect(screen.getByText('MaintenanceType')).toBeDefined();
  });

  it('should have create button', () => {
    render(<MaintenanceTypeList />, { wrapper });
    expect(screen.getByText('+ Create MaintenanceType')).toBeDefined();
  });
