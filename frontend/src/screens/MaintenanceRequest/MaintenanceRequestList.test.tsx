...
describe('MaintenanceRequestList', () => {
  it('should render without crashing', () => {
    const { container } = render(<MaintenanceRequestList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<MaintenanceRequestList />, { wrapper });
    expect(screen.getByText('MaintenanceRequest')).toBeDefined();
  });

  it('should have create button', () => {
    render(<MaintenanceRequestList />, { wrapper });
    expect(screen.getByText('+ Create MaintenanceRequest')).toBeDefined();
  });
