...
describe('MaintenanceLogList', () => {
  it('should render without crashing', () => {
    const { container } = render(<MaintenanceLogList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<MaintenanceLogList />, { wrapper });
    expect(screen.getByText('MaintenanceLog')).toBeDefined();
  });

  it('should have create button', () => {
    render(<MaintenanceLogList />, { wrapper });
    expect(screen.getByText('+ Create MaintenanceLog')).toBeDefined();
  });
